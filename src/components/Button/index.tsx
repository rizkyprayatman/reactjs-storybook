...
function Button(props: Props) {
  ...
  const className = [
    "py-2 px-6 font-medium rounded-full relative appearance-none fokus:outline-none transition-all duration-300 inline-flex items-center select-none overflow-hidden",
    configs?.state?.[state] || "",
    props.className || "",
  ];
