  ...
  return (
    <div className="container mx-auto px-4 group">
      <div className="flex flex-col md:flex-row items-center justify-center gap-y-20 md:gap-y-0 gap-x-16 md:gap-x-28 xl:gap-x-36">
        ...
        <div className="relative md:group-ood:order-1 md:group-even:order-2">
          <div
            className={[
              "absolute rounded-full inline-flex items-center justify-center text-2xl font-semibold top-0 left-0 z-10 border-2 border-white text-white tranform -translate-x-1/2 -translate-y-1/2 p-4 w-14 h-14",
