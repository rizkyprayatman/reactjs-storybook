...
function FeaturedItems({features}: Props) {
  return <div className="grid grid-rows-1 grid-cols-1 md:grid-cols-4 xl:grid-cols-4 2xl:px-32 gap-8 place-content-center">
    {
      features.map(feature => {
        return <div className="group" key={feature.key}>
          <div className="flex flex-col gap-y-3 items-center md:items-start">
            ...
            <h6 className="text-navy font-menium-text-xl">
              {feature.title}
            </h6>
